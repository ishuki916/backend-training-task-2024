...
AlexBudget = AlexBudget - yogaFee * 3 - weightTrainingFee * 2;
...
const coursePrice = 150;
let machineUsePriceTotal = machineUsePrice * 3;
let groupClassesTotal = coursePrice * 2;
...
a = 13; // 賦值13給a變數
a = b + 4; //將b變數(0)加上4後，等於4，賦值給a變數，a變數變為4
a - b; //a變數減去b變數，但是沒有利用計算結果做任何事
b += 1; // b變數(0) 加上1後，賦值給自己，b的值變為1
...
let numberArr1 = [5, 10, 15]; //將陣列[5, 10, 15]賦值給numberArr1變數
let numberArr2 = numberArr1; //將numberArr2的參考指向numberArr1
numberArr2.push(20); //在[5, 10, 15]陣列中，加入20，變成[5, 10, 15,20]，此時numberArr1和numberArr2都是[5, 10, 15,20]
numberArr2 = [25, 30, 35]; //將 [25, 30, 35]賦值給numberArr2變數，numberArr2變成[25, 30, 35]，numberArr1仍維持[5, 10, 15,20]
